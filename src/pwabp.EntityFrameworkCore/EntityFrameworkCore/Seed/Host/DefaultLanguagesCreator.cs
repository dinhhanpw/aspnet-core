...
namespace pwabp.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly pwabpDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = pwabpConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(pwabpDbContext context)
        {
            _context = context;
        }
