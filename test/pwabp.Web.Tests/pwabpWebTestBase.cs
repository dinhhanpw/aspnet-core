...
{
    public abstract class pwabpWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static pwabpWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(pwabpWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<pwabpDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<pwabpDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<pwabpDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<pwabpDbContext, Task<T>> func)
        {
            T result;
